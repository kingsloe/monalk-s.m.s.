...
from .views import (
     ...
     admin_view_individual_teacher_info_view,
...
urlpatterns = [
    ...
    path('view-all-teachers/', admin_view_all_teachers_view,
     ...
     path('view-teacher-<str:pk>-info/', admin_view_individual_teacher_info_view, 
          name='admin_view_individual_teacher_info'),
    path('update-teacher-<str:pk>-info/', admin_update_individual_teacher_info_view,
